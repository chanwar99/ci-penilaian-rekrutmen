  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-button">
        <button class="btn btn-primary" data-toggle="modal" data-target="#questionModal" data-backdrop="static" data-modal-type="add">Tambah Baru</button>
      </div>
            ...
            <div class="card-body">
              <div class="row">
                <div class="form-group col-md-4">
                  <select class="form-control select2" id="filterTopic">
              ...
              <div class="row">
                <div class="col-12 table-responsive">
                  <table class="table table-striped display" id="tableQuestion" style="width: 100%;">
                    <thead>
                      <tr>
                        <th>No</th>
                        <th>Topik</th>
